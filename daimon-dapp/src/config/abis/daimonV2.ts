...
// Fonte: out/DaimonV2.sol/DaimonV2.json
export const daimonV2Abi = [
  {
    "type": "constructor",
    "inputs": [],
  ...
  {
    "type": "error",
    "name": "TransferAmountExceedsMaxTx",
    "inputs": []
  },
  {
    "type": "error",

...
function ProposalCard({
  ...
  // i voti contrari non concorrono al quorum). I bps sono quelli catturati
  // alla creazione della proposta (fix #37), non il valore live: un cambio
  // di quorum in corsa non sposta l'asticella delle proposte in volo.
